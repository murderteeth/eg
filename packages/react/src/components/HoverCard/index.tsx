...
export function HoverCardTrigger({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: div needed for trigger wrapper styling
    <div
...
export function HoverCard({
  ...
  return (
    <div className="flex">
      {/* biome-ignore lint/a11y/useSemanticElements: div needed for hover positioning */}
      <div
        data-open={isOpen}
