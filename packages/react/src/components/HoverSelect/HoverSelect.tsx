  ...
  const handleSelect = useCallback(
    (option: SelectOption<T>) => {
      ...
      if (multiple) {
        ...
        // Clear selection if clicking the already selected item
    ...
    [multiple, setValue, toggleMultiValue, onChange, multiValues, value],
  )
    ...
    >
      <div>
        ...
        {options.map((option) => {
          ...
          if (renderOption) {
            return (
              // biome-ignore lint/a11y/useSemanticElements: div needed for custom option rendering
              <div
